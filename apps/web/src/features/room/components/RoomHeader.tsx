...
import { DropdownMenu, DropdownMenuTrigger, DropdownMenuContent, DropdownMenuItem } from '@/shared/components/Dropdown';
      ...
      <div className="flex items-center gap-1.5">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <button
              className="flex items-center gap-1.5 rounded-lg px-2.5 py-1.5 text-xs font-medium text-surface-400 hover:bg-surface-800 hover:text-surface-200 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500"
          ...
          <DropdownMenuContent align="end" className="w-48 z-50">
            <DropdownMenuItem asChild>
              <Link
                ...
                target="_blank"
                className="w-full text-surface-200 hover:text-white"
              >
                <FileText size={14} className="text-surface-400 mr-2" />
                PDF / Print
              </Link>
            </DropdownMenuItem>
            ...
            <DropdownMenuItem 
              ...
              className="w-full text-surface-200 hover:text-white cursor-pointer"
            >
              <Database size={14} className="text-surface-400 mr-2" />
              Room Snapshot
            </DropdownMenuItem>
            ...
            <DropdownMenuItem 
              ...
              className="w-full text-surface-200 hover:text-white cursor-pointer"
            >
              <Video size={14} className="text-surface-400 mr-2" />
              Replay Data
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
